...
func equals(a []int, b []int) bool {
	...
	_, _ = a, b
	// verifica se ambos sao vazios 
	if EhVazio(a) && EhVazio(b) {
		return true
	}
	//verifica se um é vazio
	if EhVazio(a) || EhVazio(b) {
		return false
	}
	// compara o primeiro elemento dos vetores, se forem iguais, chama a função recursivamente para comparar o restante dos vetores
	if a[0] == b[0]{
